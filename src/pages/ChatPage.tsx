...
import { Send, Search, LogOut, Menu, X } from 'lucide-react';
...
const ChatPage: React.FC = () => {
  ...
  const handleSendMessage = (e: React.FormEvent) => {
    ...
    // Add message to the selected room
            ...
            <>
              ...
              <div className="bg-white p-4 border-t border-gray-200">
                <form onSubmit={handleSendMessage} className="flex items-center">
                  ...
                  <button
                    type="submit"
                    className="bg-blue-600 text-white px-4 py-2 rounded-r-md hover:bg-blue-700 transition duration-200 flex items-center"
                  >
                    <Send size={18} />
                  </button>
                </form>
